...
Notice that we make essential use of the uniformity conditions in
order to verify that the fillers we define are indeed elements in
the dependent product .  Moreover, note that, for general $J$, the
