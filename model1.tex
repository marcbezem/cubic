...
and argue that it validates Voevodsky's Univalence Axiom.
While not expressed internally in type theory, the model is expressed in a constructive metalogic.
Thus it is a step towards a computational interpretation of univalence.
It is not the final solution of this important problem: for example, the eliminator for identity types
satisfies the usual computational equations pathwise, but not definitionally.
