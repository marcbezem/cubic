...
$$
The condition $(\JJ(u,v)\rho)f = \JJ(u,v)(\rho f)$ follows from the
...
$v\rho$ and $\JJ(u,v)\rho$.  In particular for $u=\Ref~a$, this gives
...
$$
The fact that the filling operations commute with substitution ensure
